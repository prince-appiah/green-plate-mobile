...
export default function NearMeToggle({ isEnabled, onToggle, hasPermission, isLoading }: NearMeToggleProps) {
  ...
  return (
    <View
      style={[
        styles.container,
        {
          paddingTop: insets.top + 60, // Position below the location pill
        },
      ]}
    >
      <TouchableOpacity
      ...
      >
        {isLoading ? (
          <>
            ...
            <Text style={[styles.text, isEnabled && styles.textEnabled, { marginLeft: 6 }]}>
              Getting location...
            </Text>
          </>
        ) : (
