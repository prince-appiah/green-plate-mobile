  ...
  return (
    ...
    >
      ...
      <View className="px-4 pt-6 pb-8">
        ...
        <View className="mb-4">
          <Text className="text-2xl font-bold text-[#1a2e1f] mb-2">{listing.title}</Text>
          <View className="flex-row items-center">
            <Ionicons name="restaurant" size={16} color="#657c69" />
            <Text className="text-[#657c69] text-base ml-2">{listing.title}</Text>
          </View>
        </View>
          ...
          <View className="flex-row items-center justify-between">
            <View>
              ...
              <View className="flex-row items-center">
                ...
                <Text className="text-lg text-[#657c69] line-through">{formatCurrency(listing.originalPrice)}</Text>
              </View>
            </View>
            <View className="bg-[rgba(22,163,74,0.1)] rounded-2xl px-4 py-2">
              <Text className="text-[#16a34a] text-sm font-bold">{listing.quantityAvailable} left</Text>
            </View>
          </View>
        </View>
        ...
        <View className="mb-4">
          ...
          <Text className="text-[#657c69] text-base leading-6">{listing.description}</Text>
        </View>
        ...
        <View className="mb-6">
          ...
          <View className="bg-white border border-[#e5e7eb] rounded-2xl p-4">
            <Text className="text-base font-semibold text-[#1a2e1f] mb-2">{listing.title}</Text>
            {listing.description && <Text className="text-sm text-[#657c69] mb-3">{listing.description}</Text>}
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.8}
          disabled={!listing.quantityAvailable || listing.quantityAvailable === 0}
        >
      ...
      <ReservationBottomSheet
        ...
        onSuccess={() => {
          ...
          queryClient.invalidateQueries({ queryKey: reservationsQueryKeys.customerLists() });
