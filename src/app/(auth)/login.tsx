...
export default function LoginScreen() {
  ...
  return (
    <ImageBackground source={loginBg} className="grow justify-end">
      ...
      <View className="bg-white rounded-t-[24px] px-8 pt-10 pb-12 w-full items-center shadow-xl min-h-[40%]">
        ...
        <Text className="text-base text-[#657c69] text-center mb-10 px-4">
          By tracking your food waste and meal planning, you can make a positive impact on the environment and save money.
        </Text>
